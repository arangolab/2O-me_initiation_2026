...
# Measure Angle for Acceptor OP2 (chain A, resi 1830)
select donor_atom, chain 7 and resi 1 and name O2'
select acceptor_atom, chain A and resi 1830 and name OP2
select acceptor_neighbor, chain A and resi 1830 and name P
distance hbond_dist, donor_atom, acceptor_atom
angle hbond_base, donor_atom, acceptor_atom, acceptor_neighbor

# Measure Angle for Acceptor O2 (chain A, resi 1830)
select donor_atom, chain 7 and resi 1 and name O2'
select acceptor_atom, chain A and resi 1830 and name O2
select base_neighbor, chain A and resi 1830 and name C2
distance hbond_dist, donor_atom, acceptor_atom
