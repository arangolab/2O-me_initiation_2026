...
bed_dir = "/projects/b1042/Arangolab/2ome/4c_reanalysis"
output_gene_file = "pos1AnalyzedGenesHELANANO.txt"
output_codon_file = "pos1CodonFreqHELANANO.txt"
...
for filename in os.listdir(bed_dir):
    if filename.endswith("lmHeLaCodons.bed"):
