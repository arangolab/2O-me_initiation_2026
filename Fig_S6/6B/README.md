...
```2omecognates_studyNanoporeHelaC42.Rmd``` generates a barplot showing the distribution of Nm[+1] sites for each near-cognate codon per cell line. The markdown is 2omecognates_studyNanoporeHelaC42.html.
