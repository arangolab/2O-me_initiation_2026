...
# Measure Angle for Acceptor O14 (chain 2, resi 37)
#select acceptor_atom, chain 1 and resi 45 and name O2'
#select donor_atom, chain 2 and resi 37 and name O14
#select base_neighbor, chain 1 and resi 45 and name C2'
#distance hbond_dist, donor_atom, acceptor_atom
#angle hbond_base, donor_atom, acceptor_atom, base_neighbor

# Measure Angle for Acceptor O2′ (chain 1, resi 45)
#select acceptor_atom, chain 1 and resi 45 and name O2'
#select donor_atom, chain 2 and resi 37 and name ODB
#select base_neighbor, chain 1 and resi 45 and name C2'
#distance hbond_dist, donor_atom, acceptor_atom
